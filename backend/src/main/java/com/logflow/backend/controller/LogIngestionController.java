...
public class LogIngestionController {
    ...
    @PostMapping("/ingest")
    public ResponseEntity<Void> ingest(@Valid @RequestBody LogEntryRequest request) {
    ...
    public ResponseEntity<Void> ingestBatch(@Valid @RequestBody List<LogEntryRequest> batch) {
